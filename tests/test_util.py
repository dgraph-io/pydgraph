...
class TestUtil(unittest.TestCase):
    ...
    def test_extract_nodes_edges(self):
        ...
        nodes = {}
        edges = []
        util.extract_dict(nodes=nodes, edges=edges, data=json.loads(sample_json_empty_result))
        ...
        nodes = {}
        edges = []
        util.extract_dict(nodes=nodes, edges=edges, data=json.loads(sample_json_graphql_result))
        ...
        nodes = {}
        edges = []
        util.extract_dict(nodes=nodes, edges=edges, data=json.loads(sample_json_dql_result))
